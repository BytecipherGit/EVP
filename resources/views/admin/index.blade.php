          ...
          <div class="row">
              ...
              <div class="ser-box">
                ...
                <h6>
                  <div class="bg-section">
                    980 <img src="assets/admin/images/button-plus-clr.png"> 
                  </div>  
                  <a href="/all-employee">View</a>              
                </h6>
              </div>
            </div> 
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="ser-box">
                ...
                <h6>
                  <div class="bg-section">
                    240 <img src="assets/admin/images/button-plus-clr.png"> 
                  </div>  
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="ser-box">
                ...
                <h6>
                  <div class="bg-section">
                    50 <img src="assets/admin/images/button-plus-clr.png"> 
                  </div>  

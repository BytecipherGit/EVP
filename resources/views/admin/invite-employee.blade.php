        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="main-right-button-box">
              <a href="invite-email" class="disabled-btn">Invite</a>
          ...
          <table class="table table-striped invite-table-cust" style="width:100%">
            ...
            <tbody>             
              <tr>
                ...
                <td>Vijay Patil</td>
                <td>Senior</td> 
                <td> <button class="pushme-Acp with-color-bg active-btn-bg">Accepted</button></td>
                ...
                <td class="d-flex">
                  ...
                  <a href="invite-view-employee" class="view-btn">View</a> 
                  <a href="#" class="edit-btn" data-toggle="modal" data-target="#deletebtninfo">Delete</a></td>
              </tr> 
              <tr>
                ...
                <td>Shivani Gupta</td>
                <td>Junior</td>
                <td> <button class="pushme-Acp with-color-bg dective-btn-bg">Declied</button></td>
                <td><button class="pushme with-color dective-btn-bg">Dropped</button></td>
                <td class="d-flex">
                  <span class="notifi-td" data-toggle="modal" data-target="#remaiderbtninfo"><img src="assets/admin/images/bell-icon.png"></span> 
                  <a href="invite-view-employee" class="view-btn">View</a> 

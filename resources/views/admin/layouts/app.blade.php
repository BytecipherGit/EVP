...
<head>
  ...
  <link rel="stylesheet" href="assets/admin/css/header-css.css">

  <link rel="stylesheet" href="assets/admin/css/main-container.css">
...
<body>
  ...
  <header> 
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
      <a class="navbar-brand" href="admin-index"><img src="assets/admin/images/logo.png"></a>
        ...
        <ul class="navbar-nav ml-auto">          
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle dropdown-toggle1" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img src="assets/admin/images/notifications-icon.png">
            </a> 
          ...
          <li class="nav-item dropdown">
            <a class="nav-link profile-droup dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img src="assets/admin/images/marvin-kinney-profile.png"> 
              <span>
                John Smith              
              </span>
              <img src="assets/admin/images/droup-down-gray.png" class="right-doun">
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item dropdown-item-no" href="#">               
                Sign out
                <img src="assets/admin/images/logout-icon.png" class="ml-auto">
              </a>
            </div>
          </li>    
        </ul>  
      ...
      <aside>
        ...
        <li>
          <a href="search-history">
            <img src="assets/admin/images/search-icon-gray.png">
            Search
          </a>
        </li>
        ...
        <li class="active">
          <a href="admin-index">
            <img src="assets/admin/images/overview-icon.png">
            Overview
          </a>
        </li>  
                  ...
                  <ul>                    
                    ...
                    <li>
                      <a href="post-employee">
                        <img src="assets/admin/images/employees-icon.png"> Past Employee
                      </a>
                    </li>
        ...
        <li>
          <a href="schedule-for-interview">
            <img src="assets/admin/images/schedule-icon.png"> 
        ...
        <hr>
         ...
         <li>
          <a href="settings">
            <img src="assets/admin/images/setting-icon.png">
            Settings
          </a>
        </li>

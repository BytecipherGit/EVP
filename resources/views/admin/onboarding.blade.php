                  ...
                  <div class="row">                  
                    <div class="col-lg-3">
                      <div class="profile-add-img">
                        <div class="circle">
                           <img class="profile-pic" id="profile-pic" src="assets/admin/images/user-img.png">
                         </div>
                      ...
                      <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="" class="form-control" placeholder="Enter Your First Name">
                          </div>
                        </div>  
                        <div class="col-xl-4 col-lg-6 col-md-12">
                          <div class="form-group">
                            <label>*Middle Name</label>
                            <input type="text" name="" class="form-control" placeholder="Enter Your Middle Name">
                          </div>
                        </div>  
                        <div class="col-xl-4 col-lg-6 col-md-12">
                          <div class="form-group">
                            <label>*Last Name</label>
                            <input type="text" name="" class="form-control" placeholder="Enter Your Last Name">
                          </div>                          
                        </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form>
                      <div class="row">
                        <div class="col-xl-12">
                          <h2>Qualification <span class="ml-auto on-head-right" data-toggle="modal" data-target="#qualificationAdd"><img src="assets/admin/images/button-plus-clr.png"> <small>Add</small></span></h2>
                        </div>
                        <p class="no-data-clg">No Data Available</p>  
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>                                    
                                    ...
                                    <td><span class="not-verified-clr"><i class="fa fa-times"></i> Not Verified</span></td>
                                    <td>
                                      <a class="docu-down" data-toggle="modal" data-target="#qualificationinfo"><img src="assets/admin/images/no-data.png"></a>
                                      <a href="assets/admin/images/job-offer-letter.png" target="_black" class="docu-download"><img src="assets/admin/images/download-icon.png"></a>
                                      <button type="button" class="border-none" data-toggle="modal" data-target="#qualificationEdit"><img src="assets/admin/images/edit-icon.png"></button>
                                    </td>
                                  </tr>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form>
                      <div class="row">
                        <div class="col-xl-12">
                          <h2>Work History <span class="ml-auto on-head-right" data-toggle="modal" data-target="#workHistorybtn"><img src="assets/admin/images/button-plus-clr.png"> <small>Add</small></span></h2>
                        </div>
                        <p class="no-data-clg">No Data Available</p>  

                ...
                <div class="login-box-txt">
                    ...
                    <form action="" data-toggle="modal" method="post" class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="admin" class="form-control" value="{{ old('admin') }}"
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dept" class="form-control"
                                        value="{{ old('dept') }}" placeholder="Department">
                                    @error('dept')
                                        <p class="velidation">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" value="{{ old('address') }}" placeholder="Enter Your Address"
                                rows="2"></textarea>
                            @error('address')
                                <p class="velidation">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pin" class="form-control"
                                        value="{{ old('pin') }}" placeholder="Enter Your pin">
                                    @error('pin')
                                        <p class="velidation">{{ $message }}</p>
                                    @enderror
                                </div>

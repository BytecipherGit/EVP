    ...
    <section style="max-width: 680px; margin:20px auto; background:#f2f2f3; display:block; border-radius: 10px;"> 
        <center>
            ...
            <div style="background: #fff; border-top:4px solid #5533FF; margin:0 30px; padding:0 0 30px">
                ...
                <img src="images/user-icon.png" style="margin-bottom: 20px; width: 100px;">
                <h2 style="font-weight: 800; font-size: 18px; line-height: 32px; color: #373E57; padding: 0 40px 22px; margin:0;">
                    Hello (Org Name)
                </h2>
                <p style="font-size: 14px; line-height: 32px; color: #373E57; padding: 0 20px 0; margin:0; font-family: 'DM Sans', sans-serif;"> 
                    Thank you, your email has been verified. Your account is now active.</p> 
                <p style="font-size: 14px; line-height: 32px; color: #373E57; padding: 0 20px 5px; margin:0; font-family: 'DM Sans', sans-serif;"> Please use for the link below to loginto your account. </p>
                <button style="background: #5533FF; border:none; border-radius: 6px; padding:15px 40px; margin:15px 40px">
                    <a href="../web/company-login.html" style="color: #fff; text-decoration:none; font-weight: 500; font-size: 20px; line-height: 26px; font-family: 'DM Sans', sans-serif;" target="_black">

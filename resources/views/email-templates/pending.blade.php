    ...
    <section style="max-width: 680px; margin:20px auto; background:#f2f2f3; display:block; border-radius: 10px;"> 
        <center>
            ...
            <div style="background: #fff; border-top:4px solid #5533FF; margin:0 30px; padding:0 0 30px">
                ...
                <img src="images/pending-icon.png" style="margin-bottom: 20px; width: 100px;">
                ...
                Thanks for reaching out to us. We appreciate your interest in our application. This is to confirm that we’ve successfully received your request for EVP.<br>
Your request for EVP resigtration is under process, please wait for 24hours.<br>
If you need immediate assistance or have any further questions, feel free to call us.</p> 

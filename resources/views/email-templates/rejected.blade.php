    ...
    <section style="max-width: 680px; margin:20px auto; background:#f2f2f3; display:block; border-radius: 10px;"> 
        <center>
            ...
            <div style="background: #fff; border-top:4px solid #5533FF; margin:0 30px; padding:0 0 30px">
                ...
                <img src="images/rejected-icon.png" style="margin-bottom: 20px; width: 100px;">
                <h2 style="font-weight: 800; font-size: 18px; line-height: 32px; color: #373E57; padding: 0 40px 22px; margin:0;">
                    Hi ByteCipher, 
                </h2>
                <p style="font-size: 18px; line-height: 32px; color: #373E57; padding: 0 20px 0px; margin:0; font-family: 'DM Sans', sans-serif; text-align: center;"> 
                    Thank you so much for taking the time to reach out to us and for your interest in our business/application.<br> We really appreciate you putting your trust in our services. Unfortunately, we are unable to fulfill your request due wrong GST No.</p> 
                <button style="background: #5533FF; border:none; border-radius: 6px; padding:15px 40px; margin:15px 40px">
                    <a href="../web/company-signup.html" style="color: #fff; text-decoration:none; font-weight: 500; font-size: 20px; line-height: 26px; font-family: 'DM Sans', sans-serif;" target="_black">
                    Try Again
                    </a>
                </button>
                 <p style="font-weight:600; font-size: 14px; line-height: 32px; color: #373E57; padding:0px 40px; margin: 0;">
                    Thanks for visiting us!
                </p>
            </div> 

            <footer style="padding:20px;">
                <p style="font-weight:300;font-size: 16px; line-height: 24px; color: #373E57; font-family: 'DM Sans', sans-serif; margin: 0;">Copyright 2022 <span style="color: #5533FF;">EVP</span>. All Right Reserved.</p>

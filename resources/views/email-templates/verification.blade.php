...
<body style="margin: 0 auto; padding:0; font-family: 'Poppins', sans-serif;" >
    ...
    <section style="max-width: 680px; margin:20px auto; background:#ececed; display:block; border-radius: 10px;"> 
        <center>
            ...
            <div style="background: #fff; border-top:4px solid #5533FF; margin:0 30px; padding:0 0 30px">
                ...
                <img src="images/verified-icon.png" style="margin-bottom: 20px; width: 100px;">
                ...
                <p style="font-size: 18px; line-height: 32px; color: #373E57; padding: 0 20px 0px; margin:0; font-family: 'DM Sans', sans-serif; text-align: center;"> 
                    You have successfully created a EVP account. Please click on the link below login to your account.</p> 

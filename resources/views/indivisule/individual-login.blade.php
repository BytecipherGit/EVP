          ...
          <div class="login-box-txt">  
            <form>
              <div class="d-flex close-butn">
                <a href="index.html"><img src="assets/company2/images/back-icon.png"></a>
              </div>
              <h1>Welcome Guest,</h1> 
              ...
              <div class="form-group">  
                ...
                <input type="text" name="" class="form-control" placeholder="Email/Mobile">
              </div>             
              <div class="form-group">
                <button type="submit"><a href="individual-login-otp.html">Generate OTP</a></button>
              </div>

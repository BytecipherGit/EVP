...
<head>
  ...
  <link rel="icon" href="assets/org-invite/images/logo-icon.png">
  <link rel="stylesheet" href="assets/org-invite/css/bootstrap.min.css">
  <link rel="stylesheet" href="assets/org-invite/css/font-awesome.min.css">
  <link rel="stylesheet" href="assets/org-invite/css/main-container.css">

  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">

  <script src="assets/org-invite/js/jquery.min.js"></script>
...
<body>  
  ...
  <div class="wapper">
    ...
    <div class="main-container">
      ...
      <div class="main-heading">        
        <div class="row">
          <div class="col-md-12">
            <div class="company-name"><img src="assets/org-invite/images/logo.png"></div>
            <h1>Welcome to ByteCipher</h1>
                  ...
                  <div class="row">                  
                    <div class="col-lg-3">
                      <div class="profile-add-img">
                        <div class="circle">
                           <img class="profile-pic" id="profile-pic" src="assets/org-invite/images/user-img.png">
                         </div>
                         <div class="p-image ml-auto">
                           <span class="upload-button" id="upload-button"><img src="assets/org-invite/images/edit-icon.png"></span>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="" class="form-control" placeholder="Enter Your Number">
                          </div>
                        </div>
                      </div> 
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="" class="form-control" placeholder="Enter Relation">
                      </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12">
                      <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form>
                      <div class="row">
                        <div class="col-xl-12">
                          <h2>Uploaded Documents <span class="ml-auto on-head-right" data-toggle="modal" data-target="#identityAdd"><img src="assets/org-invite/images/button-plus-clr.png"> <small>Add</small></span></h2>
                        </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <span class="d-flex tbl-iconBx">
                                          <a href="#" target="_black" class="docu-down" data-toggle="modal" data-target="#exampleModaldocument"><img src="assets/org-invite/images/document.png"></a>
                                          <a href="assets/org-invite/images/pan-card.png" target="_black" class="docu-download"><img src="assets/org-invite/images/download-icon.png"></a>
                                          <button type="button" class="border-none" data-toggle="modal" data-target="#identityEdit"><img src="assets/org-invite/images/edit-icon.png"></button>
                                        </span>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td>
                                        <span class="d-flex  tbl-iconBx">
                                          <a class="docu-down" data-toggle="modal" data-target="#btninfo"><img src="assets/org-invite/images/no-data.png"></a>
                                          <a href="assets/org-invite/images/pan-card.png" target="_black" class="docu-download"><img src="assets/org-invite/images/download-icon.png"></a>
                                          <button type="button" class="border-none" data-toggle="modal" data-target="#identityEdit"><img src="assets/org-invite/images/edit-icon.png"></button>
                                        </span>
                                      </td>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form>
                      <div class="row">
                        <div class="col-xl-12">
                          <h2>Qualification <span class="ml-auto on-head-right" data-toggle="modal" data-target="#qualificationAdd"><img src="assets/org-invite/images/button-plus-clr.png"> <small>Add</small></span></h2>
                        </div>
                        <p class="no-data-clg">No Data Available</p>  
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  <tr>                                    
                                    ...
                                    <td>July / 2017</td>  
                                    <td>
                                      <a href="#" target="_black" class="docu-down" data-toggle="modal" data-target="#qualificationdocument"><img src="assets/org-invite/images/document.png"></a>
                                      <a href="assets/org-invite/images/job-offer-letter.png" target="_black" class="docu-download"><img src="assets/org-invite/images/download-icon.png"></a>
                                      <button type="button" class="border-none" data-toggle="modal" data-target="#qualificationEdit"><img src="assets/org-invite/images/edit-icon.png"></button>
                                    </td>
                                  </tr>
                                  <tr>                                    
                                    <td>12th</td> 
                                    ...
                                    <td>March / 2013</td>  
                                    <td>
                                      <a class="docu-down" data-toggle="modal" data-target="#qualificationinfo"><img src="assets/org-invite/images/no-data.png"></a>
                                      <a href="assets/org-invite/images/job-offer-letter.png" target="_black" class="docu-download"><img src="assets/org-invite/images/download-icon.png"></a>
                                      <button type="button" class="border-none" data-toggle="modal" data-target="#qualificationEdit"><img src="assets/org-invite/images/edit-icon.png"></button>
                                    </td>
                                  </tr>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form>
                      <div class="row">
                        <div class="col-xl-12">
                          <h2>Work History <span class="ml-auto on-head-right" data-toggle="modal" data-target="#workHistorybtn"><img src="assets/org-invite/images/button-plus-clr.png"> <small>Add</small></span></h2>
                        </div>
                        <p class="no-data-clg">No Data Available</p>  
                              ...
                              <table class="table">
                                <thead>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="#" target="_black" class="docu-down" data-toggle="modal" data-target="#qualificationdocument"><img src="assets/org-invite/images/document.png"></a></td>
                                    <td><a href="#" target="_black" class="docu-down" data-toggle="modal" data-target="#qualificationdocument"><img src="assets/org-invite/images/document.png"></a></td>
                                    <td><a href="assets/org-invite/images/sample-pdf.pdf" target="_black" class="docu-download"><img src="assets/org-invite/images/pdf-icon.png"></a></td>
                                    <td><button type="button" class="border-none" data-toggle="modal" data-target="#workHistoryedit"><img src="assets/org-invite/images/edit-icon.png"></button></td>
                                  </tr>
                                  <tr>      
                                    <td>ByteCipher</td>
                                    <td>14-01-2018</td>  
                                    <td>20-10-2029</td>
                                    <td>React Native Developer</td> 
                                    <td><a class="docu-down" data-toggle="modal" data-target="#workhisinfo"><img src="assets/org-invite/images/no-data.png"></a></td>
                                    <td><a href="#" target="_black" class="docu-down" data-toggle="modal" data-target="#qualificationdocument"><img src="assets/org-invite/images/document.png"></a></td>
                                    <td><a href="assets/org-invite/images/sample-pdf.pdf" target="_black" class="docu-download"><img src="assets/org-invite/images/pdf-icon.png"></a></td>
                                    <td><button type="button" class="border-none" data-toggle="modal" data-target="#workHistoryedit"><img src="assets/org-invite/images/edit-icon.png"></button></td>
                                  </tr>
                    ...
                    <form>
                      <div class="form-group inputtag-custom">
                        ...
                        <div class="row customer_records">
                          ...
                          <a class="add-plus extra-fields-customer" ><span><img src="assets/org-invite/images/button-plus.png"></span></a>
                        </div>
                      ...
                      <div class="form-group inputtag-custom mt-3 mb-5">
                        ...
                        <div class="row customer_records1">
                          ...
                          <a class="add-plus extra-fields-customer1" ><span><img src="assets/org-invite/images/button-plus.png"></span></a>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12">
                          <div class="form-group">
                            ...
                            <input type="date" name="" class="form-control" value="DOJ">
                          </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                          <div class="form-group">
                            <label>Probation Period</label>
                            <input type="text" name="" class="form-control" value="50 Days">
                          </div>
                        </div> 
                        <div class="col-xl-3 col-lg-6 col-md-12">
                          <div class="form-group">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12">
                          <div class="form-group">
                            <label>LPA</label>
                            <input type="text" name="" class="form-control" value="2,52,000">
                          </div>
                        </div>
                      ...
                      <div class="col-xl-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="selectBox active form-control">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a class="dropdown-item active">Primary</a>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="add-btn-part">
                              <button type="button" class="btn-secondary-cust" data-dismiss="modal">Cancel</button>
                              <button type="button" class="btn-primary-cust" onclick="/admin/index">Save</button>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <img src="assets/org-invite/images/confirm-icon.png" class="img-size-wth">   
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <img src="assets/org-invite/images/close-btn-icon.png">
          </button>
        </div>
        <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic1" src="assets/org-invite/images/file-icon-img.png">
                      </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic2" src="assets/org-invite/images/pan-card.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic3" src="assets/org-invite/images/file-icon-img.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic4" src="assets/org-invite/images/file-icon-img.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="document-body">
            <img src="assets/org-invite/images/job-offer-letter.png">
          </div>
          <a href="assets/org-invite/images/pan-card.png" target="_black">Download</a>
        </div>
        <div class="modal-footer">
  ...
  <div class="modal fade custu-no-select" id="qualificationinfo" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <img src="assets/org-invite/images/info.png" class="img-size-wth">
  ...
  <div class="modal fade custu-modal-popup" id="exampleModaldocument" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="document-body">
            <img src="assets/org-invite/images/pan-card.png">
          </div>
          <a href="assets/org-invite/images/pan-card.png" target="_black">Download</a>
        </div>
        <div class="modal-footer">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic5" src="assets/org-invite/images/file-icon-img.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic6" src="assets/org-invite/images/file-icon-img.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic7" src="assets/org-invite/images/file-icon-img.png">
                      </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic7" src="assets/org-invite/images/job-offer-letter.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
                        <span class="upload-button" id="upload-button7">Choose File</span>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic9" src="assets/org-invite/images/job-offer-letter.png">
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic10" src="assets/org-invite/images/pdf-icon.png">
                      </div>
                      <p>You can drag or drop <span>pdf</span> </p>
                      <div class="p-image ml-auto">
  ...
  <div class="modal fade custu-no-select" id="workhisinfo" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    ...
    <script>
      window.jQuery || document.write('<script src="../../assets/org-invite/js/vendor/jquery.min.js"><\/script>')
    </script>
    <script src="assets/org-invite/js/bootstrap.min.js"></script> 
    <script src="assets/org-invite/js/file-upload.js"></script>
    <script src="assets/org-invite/js/typeahead.min.js"></script>
    ...
    <script>
      $('.extra-fields-customer').click(function() {
        ...
        $('.single').append('<a href="#" class="remove-field btn-remove-customer add-plus minus-icon"><span><img src="assets/org-invite/images/minus-icon.png"></span></a>');

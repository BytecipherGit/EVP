    ...
    <section style="max-width: 680px; margin:20px auto; background:#f2f2f3; display:block; border-radius: 10px;"> 
        <center>
            <header style="width: 100%; padding:30px 0 20px">
                <img src="assets/org-invite/images/logo.png" style="width: 150px; background-size: cover; height: auto">
            </header> 
            <div style="background: #fff; border-top:4px solid #5533FF; margin:0 30px; padding:0 0 30px">
                ...
                You have been invited by Vijay Singh Sisodiya to join the organization: ByteCipher.  You can have access to this organization, once you accept the invite.</p> 
                ...
                <p style="text-align: center; margin-bottom: 30px; padding: 0 20px 0px; font-family: 'DM Sans', sans-serif;">
                    ...
                    <br>
                    <span>Follow the link: <a href="invite-confirm" style="text-decoration: underline; cursor: pointer; color: #18a749; ">https://bytecipher.net/employee-verification/org-invite/</a></span>
                </p>
            ...
            <footer style="padding:20px;">
                ...
                <ul style="margin:15px 0 0; padding:0">
                    <li style="list-style-type: none; display: inline-block;"><a href="#"><img src="assets/org-invite/images/instagram-icon.png"></a></li>
                    <li style="list-style-type: none; display: inline-block; padding-left: 30px;"><a href="#"><img src="assets/org-invite/images/twitter-icon.png"></a></li>
                    <li style="list-style-type: none; display: inline-block; padding-left: 30px;"><a href="#"><img src="assets/org-invite/images/facebook-icon.png"></a></li>
                    <li style="list-style-type: none; display: inline-block; padding-left: 30px;"><a href="#"><img src="assets/org-invite/images/google-icon.png"></a></li>
                </ul>
            </footer>

...
@section('title','EVP - Organization')
 ...
 <div class="main-container">
        ...
        <div class="table-responsive">
          <div class="table-effect-box">
            ...
            <span class="ms-auto d-flex cutom-filter">
              <div class="select-bx">
                <h2><span><img src="assets/superassets/images/filter-icon.png"></span>
                  <div class="selectBox">
          ...
          <table class="table table-striped invite-table-cust" style="width:100%">
            ...
            <tbody>             
              <tr>
                ...
                <td class="d-flex">
                  <a href="/organization-details/{{ $dat->id }}" class="view-btn">View</a> </td>
              </tr> 
              @endforeach                         
            </tbody>
          </table>
  ...
  <!--- Wapper Close ----->
    ...
    <script src="assets/superassets/js/pagination-script.js"></script>
